...
<section class="products">
   ...
   <?php
     $shopid = $_GET['shopid'];
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE shopid = ?"); 
     $select_products->execute([$shopid]);
   ...
   <form action="" method="post" class="box">
      ...
      <a href="quick_view.php?productid=<?= $fetch_product['productid']; ?>" class="fas fa-eye"></a>
      <img src="uploaded_img/<?= $fetch_product['image_01']; ?>" alt="">
      <div class="name"><?= $fetch_product['productname']; ?></div>
      <div class="flex">
         <div class="price"><span>$</span><?= $fetch_product['productprice']; ?><span>/-</span></div>
